...
const Versus = ({ date }: VersusProps) => {
  ...
  return (
    <div className="grid relative h-full py-3">
      <span className="absoulte font-bold text-2xl place-self-center">VS</span>
      <span className="font-medium text-1xl place-self-end bg-black rounded-full px-3 py-1 text-white">
  ...
  return (
    <div
      className={clsx(
        ...
        isToday && "hover:shadow-[20px_20px_0_0_#000000]"
      )}
    >
